...
async def verify_access_token(token: Annotated[OAuth2PasswordBearer, Depends(oauth2_bearer)], user_repository: Annotated[UserRepository, Depends(UserRepositoryImpl)]) -> TokenClaims:
    try:
